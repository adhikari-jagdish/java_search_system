...
public class search_query2 extends HttpServlet
{
            ...
            throws ServletException, IOException
   {
     ...
     // out.println(msec1);
	  ...
	  out.println("<form name=jagdish method=get action=http://127.0.0.1:8080/servlet/search_query2><FONT SIZE=2 COLOR=\"#C0C000\" FACE=\"verdana\"><b>SEARCH FOR:</b></FONT><IMG SRC=\"c:\\java\\space.gif\" width=15 height=1 ><input type=text name=srchval value=\""+title+"\" ");
	 // out.println(query);
